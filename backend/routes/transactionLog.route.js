...
import { getAllTransactionLogs, getTransactionLogById, createTransactionLog, deleteTransactionLog, getLogsForSpecificTransaction, getLogsForSpecificTransactionId, restoreTransactionLog } from "../controllers/transactionLog.controller.js"; // Import the controller functions
...
router.delete("/delete/:id", isAuthorized, isSysAdmin, hasDeleteTransactionLog, deleteTransactionLog);
