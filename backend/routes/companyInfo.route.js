...
import { createCompany, deleteCompany, getAllCompanies, getCompanyById, getFirstCompany, updateCompany } from "../controllers/companyInfo.controller.js";
...
router.get("/latest", isAuthorized, hasViewAllCompanies, getFirstCompany);
