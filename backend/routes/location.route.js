...
import { createLocation, deleteLocation, getAllLocations, getLocationById, updateLocation, restoreLocation, getAllDeletedLocations } from '../controllers/location.controller.js';
...
router.get('/deleted', isAuthorized, hasRestoreLocation, getAllDeletedLocations);
...
router.delete("/:id", isAuthorized, hasDeleteLocation, deleteLocation);
