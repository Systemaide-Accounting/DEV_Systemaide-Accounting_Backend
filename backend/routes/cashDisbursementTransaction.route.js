...
import { createCashDisbursementTransaction, deleteCashDisbursementTransaction, getAllCashDisbursementTransactions, getCashDisbursementTransactionById, updateCashDisbursementTransaction, restoreCashDisbursementTransaction, getAllDeletedCashDisbursementTransactions } from '../controllers/cashDisbursementTransaction.controller.js';
...
router.get("/deleted", isAuthorized, hasRestoreTransaction, getAllDeletedCashDisbursementTransactions);
...
router.delete("/:id", isAuthorized, hasDeleteTransaction, deleteCashDisbursementTransaction);
